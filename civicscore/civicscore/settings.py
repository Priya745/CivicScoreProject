"""
Django settings for civicscore project.
...
SECRET_KEY = 'django-insecure-gpw^db2a3hv*dbksd(ug&8=f!wm+1zl3+4f#nn1_o4sp4^3#mc'
...
ROOT_URLCONF = 'civicscore.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'templates'],                                     #it tells django to look for templates folder for html pages
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'civicscore.wsgi.application'
